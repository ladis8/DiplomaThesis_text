...
\input{SW_Application/sw_application.tex}
...
\chapter{Additional Figures, Schemes \& Charts}
    \begin{sidewaysfigure}
        \centering
        \includegraphics[page=2,width =\textwidth]{Appendix/BT_LED_CTRL-1.0-sch.pdf}
        \caption {The HW design of light control unit board (created by Pavel Porazil)}
        \label{figure:hw_lcu}
    \end{sidewaysfigure}
    
    \begin{sidewaysfigure}
        \centering
        \includegraphics[page=1,width =\textwidth]{Appendix/BT_LED_CTRL-1.0-sch.pdf}
        \caption {The HW design of light control unit board (created by Pavel Porazil)}
        \label{figure:hw_lcu2}
    \end{sidewaysfigure}
...
\printbibliography[keyword=image, title=Sources - Images]
